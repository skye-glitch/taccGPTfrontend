...
const Home = ({
  ...
  // Currently does not support languages other than English.
  // To restore this func, uncomment serverSideTranslations below 
  ...
  return (
    ...
    >
      <Head>
        <title>TACC GPT Platform</title>
        <meta name="description" content="Platform for using and building TACC GPT" />
        <meta
          name="viewport"
